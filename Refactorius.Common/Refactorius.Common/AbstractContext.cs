...
namespace Refactorius
{
        ...
        where TInstance : AbstractContext<TInstance>
    {
        ...
        [NotNull]
        public static Stack<TInstance> CurrentStack => AbstractContextHolder.Instance;
                ...
                if (!HasCurrent)
                    throw new InvalidOperationException(
                        string.Format(
                            ...
                            AbstractContextHolder.Instance.GetType().FullName));

                // ReSharper disable once AssignNullToNotNullAttribute
                return AbstractContextHolder.Instance.Peek();
            }
        }
        ...
        public static bool HasCurrent => AbstractContextHolder.Instance.Count > 0;
        ...
        public static void Register([NotNull] TInstance scope)
        {
            ...
            AbstractContextHolder.Instance.Push(scope);
        }

        /// <summary>Unregister the scope.</summary>
        /// <param name="scope">The scope.</param>
        internal static void Unregister([NotNull] TInstance scope)
        {
            scope.MustNotBeNull(nameof(scope));
            AssertUtils.Assert(
                scope == AbstractContextHolder.Instance.Peek(),
                string.Format(
                    CultureInfo.InvariantCulture,
            ...
            AbstractContextHolder.Instance.Pop();
        }

        /// <summary>The base class for the thread-owned context stacks.</summary>
        public class AbstractContextHolder : ThreadAutoSingleton<Stack<TInstance>, Stack<TInstance>>
        {
        }
