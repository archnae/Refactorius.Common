...
{
    /// <summary>Returns an array of custom attributes applied to this member and identified by <see cref="Type"/>.</summary>
    ...
    /// <exception cref="InvalidOperationException">This member belongs to a type that is loaded into the
    ...
    /// <summary>Returns an optional custom attribute applied to this member and identified by <see cref="Type"/>.</summary>
