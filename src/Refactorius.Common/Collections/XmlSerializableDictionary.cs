    ...
    where TKey: notnull
{
    ...
    /// <param name="context">A <see cref="StreamingContext"/> structure containing the source and
    ...
    /// <summary>This property is reserved, apply the <see cref="XmlSchemaProviderAttribute"/> to the
    ...
    /// consumed by the <see cref="IXmlSerializable.ReadXml(XmlReader)"/> method.</returns>
