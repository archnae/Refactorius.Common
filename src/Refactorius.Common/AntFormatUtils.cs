...
public static class AntFormatUtils
{
    ...
    /// <exception cref="FormatException">If some expression in the supplied <paramref name="text"/> is empty (as in
    /// <c>"${}"</c>).</exception>
    ...
    /// <seealso cref="FormatUtils.Format(string,IPropertyBag,object[])"/>
    /// <seealso cref="SetAntExpression(string,string,object,string,string)"/>
