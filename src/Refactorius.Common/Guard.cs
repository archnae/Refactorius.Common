...
"Argument is not an instance of '{0}' or its descendant type.";
    ...
    /// <summary>
    ///     Checks the value of the supplied <paramref name="invariant" /> and throws an <see cref="Exception" /> if
    ///     it is <see langword="false" />.
    /// </summary>
    /// <param name="invariant">The invariant to check.</param>
    /// <exception cref="Exception">If the supplied <paramref name="invariant" /> is <see langword="false" />.</exception>
    ...
    /// <exception cref="ArgumentNullException">If the supplied <paramref name="argument" /> is <see langword="null" />.</exception>
    ...
    /// <param name="name">The argument name.</param>
    /// <param name="message">
    ///     An arbitrary message that will be passed to any thrown <see cref="ArgumentNullException" />
    ///     .
    /// </param>
    /// <returns>The original <paramref name="argument" />.</returns>
    /// <exception cref="ArgumentNullException">If the supplied <paramref name="argument" /> is <see langword="null" />.</exception>
    ...
    /// <param name="message">An arbitrary message that will be passed to any thrown <see cref="ArgumentException" />.</param>
    /// <returns>The original <paramref name="argument" />.</returns>
    /// <exception cref="ArgumentException">
    ...
    ///     <see cref="ArgumentNullException" /> if it is <see langword="null" /> or
    ///     <see cref="ArgumentException" /> if
    ...
    /// <param name="argument">The string to check.</param>
    /// <param name="name">The argument name.</param>
    /// <param name="message">An arbitrary message that will be passed to any thrown <see cref="Exception" />.</param>
    /// <returns>The original <paramref name="argument" /> value.</returns>
    /// <exception cref="ArgumentNullException">If the supplied <paramref name="argument" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">
    ///     If the supplied <paramref name="argument" /> is an empty (zero-length)
    ...
    /// <summary>
    ///     Checks the value of the supplied <paramref name="argument" /> and throws an
    ///     <see cref="ArgumentException" /> if it is the default(zero) value for <typeparamref name="T" />.
    /// </summary>
    ...
    /// <returns>The original <paramref name="argument" />.</returns>
    /// <exception cref="ArgumentNullException">If the supplied <paramref name="argument" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">If the supplied <paramref name="argument" /> contains no elements.</exception>
    [ContractAnnotation("argument:null => halt")]
    ...
    /// <summary>
    ///     Checks the value of the supplied <paramref name="argument" /> and throws an
    ///     <see cref="ArgumentException" /> if it is outside the <paramref name="range" />.
    /// </summary>
    /// <typeparam name="T">The type of the argument.</typeparam>
    /// <param name="argument">The object to check.</param>
